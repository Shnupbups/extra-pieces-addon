...
public class ButtonPieceBlockItem extends PieceBlockItem {
	public ButtonPieceBlockItem(PieceBlock block_1, Settings item$Settings_1) {
	...
	public void appendTooltip(ItemStack itemStack_1, World world_1, List<Text> list_1, TooltipContext tooltipContext_1) {
		...
		if (tooltipContext_1.isAdvanced())
			list_1.add(new TranslatableText("tooltip.activationLength", ((ButtonPieceBlock) this.getPieceBlock()).getTickRate(world_1)).setStyle(new Style().setColor(Formatting.YELLOW)));
	}
}
